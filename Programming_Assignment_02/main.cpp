...
int main( int argc, char * argv[] )
{
  ...
  // myCart.push(GroceryItemDatabase::find(00075457129000));
  // myCart.push(GroceryItemDatabase::find(00038000291210));
  // myCart.push(GroceryItemDatabase::find(00025317533003));
  // myCart.push(GroceryItemDatabase::find(09073649000493));
  // myCart.push(GroceryItemDatabase::find(00835841005255));
  // myCart.push(GroceryItemDatabase::find(00688267039317));
  ...
  ///////////////////////// TO-DO (7) //////////////////////////////
    ...
    /// no charge.
  // while(){
  //   if(!GroceryItemDatabase::find((checkoutCounter.front()).upcCode)){
  //     std::cout << "The grocery item wasn't found\n";
  //     checkoutCounter.pop();
  //     break;
  //   } else{
  //   GroceryItem & item;
  //   item = GroceryItemDatabase::find(checkoutCounter.front())
  //   amountDue += item.price;
  //   std::cout << item.upcCode << "     " << item.productName <<
  //             "     " << item.brandName << "     " << item.price << endl;
  //   checkoutCounter.pop();
  //   }
  // }
  /////////////////////// END-TO-DO (7) ////////////////////////////
